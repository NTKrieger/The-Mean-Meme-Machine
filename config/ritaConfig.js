module.exports = 
{
    ...
    A square wants to come on hip ... Talks about "pod,"1 and smoke it now and then, and keeps some around to offer the fast Hollywood types.
    ...
    I had some uptown customers Bill took care of, and Bart knew a few old relics from hop smoking times, spectral janitors, grey as ashes, phantom porters sweeping out dusty halls with a slow old man's hand, coughing and spitting in the junk-sick dawn, retired asthmatic fences in theatrical hotels, Pantopon Rose the old madam from Peoria, stoical Chinese waiters never show sickness.
    
    Bart sought them out with his old junky walk, patient and cautious and slow, dropped into their bloodless hands a few hours of warmth.
    
    I made the round with him once for kicks. You know how old people lose all shame about eating, and it makes you puke to watch them? Old junkies are the same about junk. They gibber and squeal at the sight of it. The spit hangs off their chin, and their stomach rumbles and all their guts grind in peristalsis5 while they cook up, dissolving the body's decent skin, you expect any moment a great blob of protoplasm will flop right out and surround the junk. Really disgust you to see it.
    
    "Well, my boys will be like that one day," I thought philosophically.
    ...
    Unfortunately there is no proof. I would recommend that you be confined or more accurately contained in some institution, but I know of no place suitable for a man of your caliber. I must reluctantly order your release."
    ...
    The mentalist guides them to whatever the man wishes to hide: a tube of Vaseline, an enema, a handkerchief with come on it, a weapon, unlicensed alcohol. And they always submitted the suspect to the most humiliating search of his naked person on which they make sneering and derogatory comments. Many a latent homosexual was carried out in a straitjacket when they planted Vaseline in his ass. Or they pounce on any object. A pen wiper or a shoe tree.16
    ...
    "Well, as you can plainly see, the possibilities are endless like meandering paths in a great big beautiful garden. I was just scratching that lovely surface when I am purged by Party Poops
    ...
    "INDs," says Benway, "Irreversible Neural Damage. Overliberated, you might say ... a drag on the industry. "
    ...
    He does a striptease to operation scars, guiding the reluctant fingers of a victim. "Feel that suppurated swelling in my groin where I got the lymphogranulomas ... And now I want you to palpate my internal hemorrhoids."
    ...
    joselito
    And Joselito who wrote bad, class-conscious poetry began to
    cough. The German doctor made a brief examination, touching
    Joselito's ribs with long, delicate fingers. The doctor was also a
    concert violinist, a mathematician, a chess master, and a Doctor
    of International Jurisprudence with license to practice in the lavatories
    of the Hague. The doctor flicked a hard, distant glance
    across Joselito's brown chest. He looked at Carl and smiled-one
    educated man to another smile-and raised his eyebrow, saying
    without words:
    "Alzo for the so stupid peasant we must avoid use of the word
    is it not? Otherwise he shit himself with fear. Koch and spit they
    are both nasty words I think?"
    He said aloud: "It is a catarro de los pulmones."
    Carl talked to the doctor outside under the narrow arcade with
    rain bouncing up from the street against his pant legs, thinking
    how many people he tell it to, and the stairs, porches, lawns, driveways,
    corridors and streets of the world there in the doctor's eyes
    . ; . stuffy German alcoves, butterfly trays to the ceiling, silent
    portentous smell of uremia seeping under the door, suburban
    lawns to sound of the water sprinkler, in calm jungle night under
    silent wings of the Anopheles mosquito. (Note: This is not a figure.
    Anopheles mosquitoes are silent.) Thicldy carpeted, discreet
    nursing home in Kensington: stiff brocade chair and a cup of tea,
    the Swedish modern living room with water hyacinths in a yellow
    bowl-outside the china blue Northern sky and drifting clouds,
    under bad watercolors of the dying medical student.
    "A schnapps I think Frau Underschnitt."
    The doctor was talking into a phone with a chess board in front
    of him. "Quite a severe lesion I think ... of course without to see
    the fluoroscope." He picks up the knight and then replaces it
    thoughtfully. "Yes ... Both lungs ... quite definitely." He replaces
    the receiver and turns to Carl. "I have observed these people show
    amazingly quick wound recovery, with low incidence of infection.
    It is always the lungs here ... pneumonia and, of course, Old
    Faithful." The doctor grabs Carl's cock, leaping into the air with
    a coarse peasant guffaw. His European smile ignores the misbehavior
    of a child or an animal. He goes on smoothly in his eerily
    unaccented, disembodied English. "Our Old Faithful Bacillus
    Koch. " The doctor clicks his heels and bows his head. "Otherwise
    they would multiply their stupid peasant assholes into the
    sea, is it not? " He shrieks, thrusting his face into Carl's. Carl retreats
    sideways with the grey wall of rain behind him.
    "Isn't there some place where he can be treated? "
    "I think there is some sort of sanitarium," he drags out the
    word with ambiguous obscenity, "up at the District Capital. I will
    write for you the address."
    "Chemical therapy? "
    His voice falls flat and heavy in the damp air.
    "Who can say. They are all stupid peasants, and the worst of all
    peasants are the so-called educated. These people should not only
    be prevented from learning to read, but from learning to talk as
    well. No need to prevent them from thinking; nature has done that.
    "Here is the address," the doctor whispered without moving
    his lips.
    He dropped a pill of paper into Carl's hand. His dirty fingers,
    shiny over the dirt, rested on Carl's sleeve.
    "There is the matter of my fee. "
    Carl slipped him a wadded bank note . .. and the doctor faded
    into the grey twilight, seedy and furtive as an old junky.
    Carl saw Joselito in a big clean room full of light, with private
    bath and concrete balcony. And nothing to tall\: about there in
    the cold empty room, water hyacinths growing in a yellow bowl
    and the china blue sky and drifting clouds, fear flickering in and
    out of his eyes. When he smiled the fear flew away i n little pieces
    of light,l urked enigmatically in the high cool corners of the room.
    And what could I say feeling death around me, and the little broken
    images that come before sleep, there in the mind?
    "They will send me to the new sanitarium tomorrow. Come
    and visit me. I will be there alone."
    He coughed and took a codeineeta.
    "Doctor I understand, that is I have been given to understand,
    I have read and heard-not a medical man myself-don't pretend
    to be-that the concept of sanitarium treatment has been more
    or less supplanted, or at least very definitely supplemented, by
    chemical therapy. Is this accurate in your opinion? What I mean
    to say is,D octor,p lease tell me in all sincerity,a s one human being
    to another, what is your opinion of chemical versus sanitarium
    therapy? Are you a partisan?"
    The doctor's liver sick Indian face was blank as a dealer's.
    "Completely modern, as you can see," he gestures toward the
    room with the purple fingers of bad circulation. "Bath .. . water
    . .. flowers. The lot. " He finished in Cockney English with a triumphant
    smirk. "I will write for you a letter. "
    "This letter? For the sanitarium? "
    The doctor was speaking from a land of black rocks and great,
    iridescent brown lagoons. "The furniture ... modern and comfortable.
    You .find it so of course? "
    Carl could not see the sanitarium owing to a false front of green
    stucco topped by an intricate neon sign dead and sinister against
    the sky, waiting for darlmess. The sanitarium was evidently built
    on a great limestone promontory, over which flowering trees and
    vine tendrils broke in waves. The smell of flowers was heavy in
    the air.
    The commandant sat at a long wooden trestle under a vine
    trellis. He was doing absolutely nothing. He took the letter that
    Carl handed him and whispered through it, reading his lips with
    the left hand. He stuck the letter on a spike over a toilet. He began
    transcribing from a ledger full of numbers. He wrote on and on.
    Broken images exploded softly in Carl's head, and he was moving
    out of himself in a silent swoop. Clear and sharp from a great
    distance he saw himself sitting in a lunchroom. Overdose of H. His
    old lady shaking him and holding hot coffee under his nose.
    Outside an old junky in Santa Claus suit selling Christmas
    seals. "Fight tuberculosis, folks," he whispers in his disembodied,
    junky voice. Salvation Army choir of sincere, homosexual
    football coaches sings: "In the Sweet Bye and Bye."
    Carl drifted back into his body, an earthbound junk ghost.
    "I could bribe him, of course."
    The commandant taps the table with one finger and hums
    "Coming Through the Rye." Far away, then urgently near like a
    foghorn a split second before the grinding crash.
    Carl pulled a note half out of his trouser pocket ... The commandant
    was standing by a vast panel of lockers and deposit
    boxes. He looked at Carl, sick animal eyes gone out, dying inside,
    hopeless fear reflecting the face of death. In the smell of
    flowers a note half out of his pocket, the weakness hit Carl, shutting
    off his breath, stopping his blood. He was in a great cone
    spinning down to a black point.
    "Chemical therapy?" The scream shot out of his flesh through
    empty locker rooms and barracks, musty resort hotels, and spectral,
    coughing corridors of T.B. sanitariums, the muttering, hawking,
    grey dishwater smell of flophouses and Old Men's Homes,
    great, dusty customs sheds and warehouses, through broken
    porticoes and smeared arabesques, iron urinals worn paper thin
    by the urine of a million fairies, deserted weed-grown privies with
    a musty smell of shit turning back to the soil, erect wooden phallus
    on the grave of dying peoples plaintive as leaves in the wind,
    across the great brown. river where whole trees float with green
    snakes in the branches and sad-eyed lemurs watch the shore out
    over a vast plain (vulture wings husk in the dry air) . The way is
    strewn with broken condoms and empty H caps and K.Y. tubes
    squeezed dry as bone meal in the summer sun.
    "My furniture." The commandant's face burned like metal in
    the flash bulb of urgency. His eyes went out. A whiff of ozone
    drifted through the room. The "novia" muttered over her candles
    and altars in one corner.
    "It is all Trak ... modern, excellent ..." he is nodding idiotically
    and drooling. A yellow cat pulls at Carl's pant leg and runs
    onto a concrete balcony. Clouds drift by.
    "I could get back my deposit. Start me a little business someplace."
    He nods and smiles like a mechanical toy.
    "Joselito!!!" Boys look up from street ball games, bull rings and
    bicycle races as the name whistles by and slowly fades away.
    "Joselito! ... Paco! ... Pepe! ... Enrique! ..." The plaintive
    boy cries drift in on the warm night. The Trak sign stirs like a
    nocturnal beast, and bursts into blue flame.
    the black meat
    "We friends, yes?"
    ...
    Met Marv in front of the Sargasso with two Arab kids and he said:
    ...
    * * *
    ...
    The Diplomat's mouth is moving but no one can hear him.
    
    The Technician clasps his hands over his ears: "Mother of God!" he screams. His plate begins to vibrate like a Jew's harp, suddenly flies out of his mouth ... He snaps at it irritably, misses and covers his mouth with one hand.
    ...
    The body knows what veins you can hit and conveys this knowledge in the spontaneous movements you make preparing to take a shot ... Sometimes the needle points like a dowser's wand. Sometimes I must wait for the message. But when it comes I always hit blood.
    ...
    (Note: Bang-utot, literally, "attempting to get up and groaning ..." Death occurring in the course of a nightmare ... The condition occurs in males of Southeast Asiatic extraction ... In Manila about twelve cases of death by Bang-utot are recorded each year.
    ...
    "We expect additional equalizations," says the Inspector in an interview with Your Reporter. "Otherwise will occur," the Inspector lifts one leg in a typical Nordic gesture, "the bends is it not? But perhaps we can provide the suitable chamber of decompression." The Inspector opens his fly and begins looking for crabs, applying ointment from a little clay pot. Clearly the interview is at an end. "You're not going?" he exclaims. "Well, as one judge said to the other, 'Be just and if you can't be just be arbitrary.' Regret cannot observe customary obscenities." He holds up his right hand covered with a foul-smelling yellow ointment.
    
    One's Reporter rushes forward and clasps the soiled hand in both of his. "It's been a pleasure, Inspector, an unspeakable pleasure," he says peeling off his gloves, rolling them into a ball and tossing them into the wastebasket. "Expense account," he smiles.
    hasan's rumpus room
    
    Gilt and red plush. Rococo bar backed by pink shell. The air is cloyed with a sweet evil substance like decayed honey. Men and women in evening dress sip pousse-cafes through alabaster tubes.
    
    A Near East Mugwump sits naked on a bar stool covered in pink silk. He licks warm honey from a crystal goblet w-ith a long black tongue. His genitals are perfectly formed-circumcised cock, black shiny pubic hairs. His lips are thin and purple-blue like the lips of a penis, his eyes blank with insect calm. The Mugwump has no liver, maintaining himself exclusively on sweets. The Mugwump pushes a slender blond youth to a couch and strips him expertly.
    
    "Stand up and turn around," he orders in telepathic pictographs.
    
    He ties the boy's hands behind him with a red silk cord.
    ...
    Hassan's face swells, tumescent46 with blood. His lips turn purple. He strips off his suit of banknotes and throws it into an open vault that closes soundless.
    
    "Freedom Hall here, folks!" he screams in his phony Texas accent. Ten-gallon hat and cowboy boots still on, he dances the Liquefactionist Jig, ending with a grotesque cancan to the tune of "She Started a Heat Wave."
    ...
    "This citizen have a Latah he import from Indo-China. He figures to hang the Latah and send a Xmas TV short to his friends. So he fix up two ropes-one gimmicked to stretch, the other the real McCoy. But that Latah gets up in feud-state and puts on his Santa Claus suit and make with the switcheroo. Come the dawning. The citizen puts one rope on and the Latah, going along the way Latahs will, puts on the other. When the traps are down the citizen hangs for real and the Latah stand with the carny-rubber stretch rope. Well, the Latah imitate every twitch and spasm. Come three times.
    
    "Smart young Latah keep his eye on the ball. I got him working in one of my plants as an expeditor."
    
    Aztec priests strip blue feather robe from the Naked Youth. They bend him back over a limestone altar, fit a crystal skull over his head, securing the two hemispheres back and front with crystal screws. A waterfall pours over the skull snapping the boy's neck. He ejaculates in a rainbow against the rising sun.
    ...
    The train tears on through the smoky, neon-lighted June night. Pictures of men and women, boys and girls, animals, fish, birds, the copulating rhythm of the universe flows through the room, a great blue tide of life. Vibrating, soundless hum of deep forest-sudden quiet of cities when the junky cops. A moment of stillness and wonder. Even the Commuter buzzes clogged lines of cholesterol for contact.47
    ...
    A.J.: "Call out my Sweitzers,48 God damn it! Guard me from these she-foxes!"
    ...
    A.J. whips out a cutlass and hegins decapitating the American Girls. He sings lustily:
    ...
    PROF: "Oh landsakes!" He tries desperately to disguise himself as an old woman with high black shoes and umbrella ... "If it wasn't for my lumbago can't rightly bend over I'd turn to them offering my Sugar Bum the way baboons do it ... If a weaker baboon be attacked by a stronger baboon the weaker baboon will either (a) present his hrump fanny I believe is the word, gentlemen, heh heh for passive intercourse or (b) if he is a different type baboon more extrovert and well-adjusted, lead an attack on an even weaker baboon if he can find one."
    
    Dilapidated Diseuse49 in 1920 clothes like she sleep in them ever since undulates across dreary neon-lighted Chicago street ... dead weight of the Dear Dead Days hanging in the air like an earthbound ghost.
    
    DISEUSE (canned heat tenor): "Find the weakest baboon."
    ...
    (Yohimbine, derived from the bark of a tree growing in Central Africa, is the safest and most efficient aphrodisiac. It operates by dilating the blood vessels on the surface of the skin, particularly in the genital area.)
    ...
    "Come along, baby." She leads the way into the bedroom. He lies down on his back and throws his legs back over his head, clasping elbows behind his knees. She kneels down and caresses the backs of his thighs, his balls, running her fingers down the perineal divide. She pushes his cheeks apart, leans down and begins licking the anus, moving her head in a slow circle. She pushes at the sides of the asshole, licking deeper and deeper. He closes his eyes and squirms. She licks up the perineal divide. His small, tight balls ... A great pearl stands out on the tip of his circumcised cock. Her mouth closes over the crown. She sucks rhythmically up and down, pausing on the up stroke and moving her head around in a circle. Her hand plays gently with his balls, slides down and middle finger up his ass. As she sucks down toward the root of his cock she tickles his prostate mockingly. He grins and farts. She is sucking his cock now in a frenzy. His body begins to contract, pulling up toward his chin. Each time the contraction is longer.
    
    "Wheeeeeeee!" the boy yells, every muscle tense, his whole body straining to empty through his cock. She drinks his jissom which fills her mouth in great hot spurts. He lets his feet flop back onto the bed. He arches his back and yawns. Mary is strapping on a rubber penis: "Steely Dan III from Yokohama," she says, caressing the shaft. Milk spurts across the room...
    
    "Be sure that milk is pasteurized. Don't go giving me some kinda awful cow disease like anthrax or glanders51 or aftosa..."52
    ...
    "Barefoot boy, check thy bullheads with the madam."
    ...
    She puts on a record, metallic cocaine bebop. She greases the dingus, shoves the boy's legs over his head and works it up his ass with a series of corkscrew movements of her fluid hips. She moves in a slow circle, revolving on the axis of the shaft. She rubs her hard nipples across his chest. She kisses him on neck and chin and eyes. He runs his hands down her back to her buttocks, pulling her into his ass. She revolves faster, faster. His body jerks and writhes in convulsive spasms. "Hurry up, please," she says.
    
    "The milk is getting cold." He does not hear. She presses her mouth against his. Their faces run together. His sperm hits her breast with light, hot licks.
    
    Mark is standing in the doorway. He wears a turtleneck black sweater. Cold, handsome, narcissistic face. Green eyes and black hair. He looks at Johnny with a slight sneer, his head on one side, hands in his jacket pockets, a graceful hoodlum ballet. He jerks his head and Johnny walks ahead of him into the bedroom. Mary follows. "All right, boys," she says, sitting down naked on a pink silk dais overlooking the bed. "Get with it!" Mark begins to undress with fluid movements, hip-rolls, squirms out of his turtleneck sweater revealing his beautiful white torso in a mocking belly dance. Johnny deadpan, face frozen, breath quick, lips dry, removing his clothes and dropping them on the floor. Mark lets his shorts fall on one foot. He kicks like a chorus-girl, sending the shorts across the room. Now he stands naked, his cock stiff, straining up and out. He runs slow eyes over Johnny's body. He smiles and licks his lips,
    ...
    The old queer squirms on a limestone bench in Chapultepec Park as Indian adolescents walk by, arms around each other's necks and ribs, straining his dying flesh to occupy young buttocks and thighs, tight balls and spurting cocks.
    ...
    Mark flips the switch and the chair vibrates ... Mark tilts his head looking up at Johnny, his face remote, eyes cool and mocking on Johnny's face ... Johnny screams and whimpers ... His face disintegrates as if melted from within ... Johnny screams like a mandrake, blacks out as his sperm spurts, slumps against Mark's body an angel on the nod. Mark pats Johnny's shoulder absently ...
    
    Room like gymnasium ... The floor is foam rubber, covered in white silk ... One wall is glass ... The rising sun fills the room with pink light. Johnny is led in, hands tied, between Mary and Mark. Johnny sees the gallows and sags with a great "Ohhhhhhhhhhh! " his chin pulling down towards his cock, his legs bending at the knees. Sperm spurts, arching almost vertical in front of his face.
    
    Mark and Mary are suddenly impatient and hot ... They push Johnny forward onto the gallows platform covered with moldy jockstraps and sweat shirts. Mark is adjusting the noose.
    ...
    * * *
    ...
    The way is long. Hard-ons and bring-downs are frequent. It was a long time over the stony reg to the oasis of date palms where Arab boys shit in the well and Rock and Roll across the sands of muscle beach eating hot-dogs and spitting out gold teeth in nuggets.
    ...
    "Gentlemen, the human nervous system can be reduced to a compact and abbreviated spinal column. The brain, front, middle and rear must follow the adenoid,55 the wisdom tooth, the appendix ... I give you my Master Work: The Complete All American Deanxietized Man ..."
    ...
    "We must stomp out the Un-American crittah," says a fat, frogfaced Southern doctor who has been drinking corn out of a mason jar. He advances drunkenly, then halts, appalled by the formidable size and menacing aspect of the centipede...
    
    "Fetch gasoline!" he bellows. "We gotta burn the son of a bitch like an uppity Nigra!"
    
    "I'm not sticking my neck out, me," says a cool hip young doctor high on LSD2556 ... "Why a smart D.A. could ..."
    ...
    the market
    Panorama of the City of Interzone. Opening bars of "East St. Louis Toodle-oo" ... at times loud and clear then faint and intermittent like music down a windy street ... The Composite City where all human potentials are spread out in a vast silent market.
    ...
    '"I'll have one more, Gus. Then, by Allah, I will go home and receive a Sura ... Wait'll the morning edition hits the souks. I am blasting Amalgamated Images wide open.'
    ...
    '"Well, Gus, I got like two types publicity, favorable and otherwise. You want some otherwise already? I am subject to receive a Sura concerning bartenders who extendeth not credit to those in a needy way.'
    
    '"And theirs will be a painful doom. Sold Arabia.' He vaults over the bar. 'I'm not taking any more, Ahmed. Pick up thy Suras and walk. In fact, I'll help you. And stay out.'
    ...
    '"Nay, nothing shall stern the rising tide.'
    
    '"I can't stern him, boys. Sauve qui peut.'
    ...
    Greek lads white as marble fuck dog style on the portico of a great golden temple ... naked Mugwump twangs a lute. Walking down by the tracks in his red sweater met Sammy the Dock Keeper's son with two Mexicans.
    ...
    A.J. is seized with a fit of coughing ... "Make with the fans!" he yells. "I'm suffocatin'!"
    
    Mr. Hyslop is coughing into a handkerchief. He presses a button.
    
    Fans whir and thin out the ambrosia.
    
    A.J. installs himself at the rudder on a raised dais. "Contact!" The barge begins to vibrate. "Avanti, God damn it!" A.J. yells and the barge takes off across the canal at a tremendous speed, overturning gondolas full of tourists, missing the motoscafi59 by inches, veering from one side of the canal to the other (the wake washes over the sidewalks drenching passersby), shattering a fleet of moored gondolas, and finally piles up against a pier, spins out into the middle of the canal ... A column of water spurts six feet in the air from a hole in the hull.
    
    "Man the pumps, Mr. Hyslop. She's shipping water."
    
    The barge gives a sudden lurch throwing A.J. into the canal.
    ...
    He drives a gold stake into the floor and pickets the baboon.
    ...
    A.J.: "So there I was flat on my stomach at thirty thousand feet." Several nearby fags raise their heads like animals scenting danger. A.J. leaps to his feet with an inarticulate snarl. "You purple-assed cocksucker!" he screams. "I'll teach you to shit on the floor!" He pulls a whip from his umbrella and cuts the baboon across the ass. The baboon screams and tears loose the stake. He leaps on the next table and climbs up an old woman who dies of heart failure on the spot.
    ...
    Clem and Jody, two old-time vaudeville hoofers, cop out as Russian agents whose sole function is to represent the U.S. in an unpopular light. When arrested for sodomy in Indonesia, Clem said to the examining magistrate:
    ...
    "We sure did. And you lmow, those citizens were so loaded on that marijuana they all wig inna middle of the banquet ... Me, I just had bread and milk ... ulcers you know."
    
    "Likewise."
    
    "So they all run around screaming they is on fire and the bull of them die the following morning."
    ...
    Salvador emits a thick screen of international finance to cloak, at least from the rank and file, his Liquefactionist activities ...
    
    But over a few stiff yages he lets his hair down among friends.
    
    "Islam is jellied consomme already," he says, dancing the Liquefactionist Jig ... And then, unable to contain himself, he bursts into a hideous falsetto:
    ...
    So this phony gives out with daily Suras on the radio: "Now friends of the radio audience, this is Ahmed your friendly prophet ... Today I'd like to talk about the importance of being dainty and kissin' fresh at all times ... Friends, use Jody's chlorophyll tablets and be sure."
    ...
    "As far as the eye can see, nothing but replicas," he says, crawling around on his terrace and speaking in strange insect chirps.
    ...
    (All viruses are deteriorated cells leading a parasitic existence ... They have specific affinity for the Mother Cell; thus deteriorated liver cells seek the home place of hepatitis, etc. So every species has a Master Virus: Deteriorated Image of that species.) The broken image of Man moves in minute by minute and cell by cell ... Poverty, hatred, war, police-criminals, bureaucracy, insanity, all symptoms of The Human Virus.
    ...
    "A bale of Levis with built-in falsie baskets. Made in Hollywood."
    ...
    "Yes, nugget, a shipload of K.Y. made of genuine whale dreck in the South Atlantic at present quarantined by the Board of Health in Tierra del Fuego. The commission, my dear! If we can pull this off we'll be in clover."
    
    (Whale dreck is reject material that accumulates in the process of cutting up a whale and cooking it down. A horrible, fishy mess you can smell for miles. No one has found any use for it.) Interzone Imports Unlimited, which consists of Marvie and Leif The Unlucky, had latched onto the K.Y. deal. In fact they specialize in pharmaceuticals and run a 24-hour Pro. station, six ways coverage fore and aft, as a side line.
    
    (Six separate venereal diseases have been identified to date.)
    
    They plunge into the deal. They perform unmentionable services for a spastic Greek shipping agent, and one entire shift of Customs inspectors. The two partners fall out and finally denounce each other in the Embassy, where they are referred to the We Don't Want To Hear About It Department and eased out a back door into a shit-strewn vacant lot, where vultures fight over fish heads. They flail at each other hysterically.
    ...
    They shake hands without enthusiasm and peck each other on the cheek.
    ...
    Everyone asks him to buy drinks and celebrate, but he laughs jovially and says, "Fact is I can't afford to buy myself a drink. I already spent every kuru of it buying Penstrep for Ali's clap. He's down with it fore and aft again. I came near kicking the little bastard right through the wall into the next bed. But you all know what a sentimental old thing I am."
    
    Marvie does buy himself a shot glass of beer, squeezing a blackened coin out of his fly onto the table. "Keep the change."
    
    The waiter sweeps the coin into a dust pan, he spits on the table and walks away.
    
    "Sorehead! He's envious of my check."
    ...
    "And not many takers either," Leif put in. He pronounced it "eye-ther."
    
    This reference to his Island origin was more than the Expeditor could stand ... He was drawing himself up, mobilizing his most frigid impersonation of an English aristocrat, preparing to deliver an icy, clipped "crusher," but instead, a whining, whimpering, kicked dog snarl broke from his mouth. His pre-surgery face emerged in an arc light of incandescent hate ... He began to spit curses in the hideous, strangled gutturals of the Island dialect. (The Islanders all profess ignorance of the dialect or flatly deny its existence. "We are Breetish," they say. "We don't got no bloody dealect.") Froth gathered at the corners of the Expeditor's mouth. He was spitting little balls of saliva like pieces of cotton. The stench of spiritual vileness hung in the air about him like a green cloud. Marvie and Leif fell back twittering in alarm.
    
    'He's gone mad," Marvie gasped. "Let's get out of here."
    ...
    He dipped into a square tin of yellow pyrethrum powder64 and pulled out a flat package covered in red and gold Chinese paper.
    ...
    "Pure, one hundred percent H. Scarcely a man is now alive ... and it's all yours."
    ...
    The waiter lets fall a drop of martini on the Man in the Grey Flannel Suit, who lams for the 6:12 Knowing That He Has Been Spotted.
    
    Junkies climb out the lavatory window of the chop suey joint as the El Rumbles past.
    
    The Gimp, cowboyed in the Waldorf, Gives Birth To A Litter Of Rats.
    ...
    And even foolish virgins heed the English colonel who rides by brandishing a screaming Peccary on his lance. The elegant fag patronizes his neighborhood pissoir to receive a bulletin from Dead Mother, lives on in synapses and will evoke the exciting Nanny Beater.
    
    Boys jacking off in the school toilet know each other as agents from Galaxy X ... adjourn to a second-run night spot where they sit shabby and portentous drinking wine vinegar and sucking lemons to confound the Tenor Sax (a hip Arab in blue glasses) suspect to be Enemy Sender.
    
    Malarials of the world bundle in shivering protoplasm ... Fear seals the turd message with a cuneiform account.
    ...
    When they walked in on me that morning at 8 o'clock, I knew it
    was my last chance, my only chance. But they didn't know. How
    could they? Just a routine pick-up. But not quite routine.
    Hauser had been eating breakfast when the Lieutenant called:
    "I want you and your partner to pick up a man named Lee, William
    Lee, on your way downtown. He's in the Hotel Lamprey. 103
    just off B' way."
    "Yeah I know where it is. I remember him too."
    "Good. Room 606. Just pick him up. Don't take time to shake
    the place down. Except bring in all books, letters, manuscripts.
    Anything printed, typed or written. Ketch?"
    "Ketch. But what's the angle ... Books ..."
    "Just do it." The Lieutenant hung up.
    Hauser and O'Brien. They had been on the City Narcotic Squad
    for 20 years. Old-timers like me. I been on the junk for 16 years.
    They weren't bad as laws go. At least O'Brien wasn't. O'Brien was
    the con man, and Hauser the tough guy. A vaudeville team.
    Hauser had a way of hitting you before he said anything, just to
    break the ice. Then O'Brien gives you an Old Gold-just like a
    cop to smoke Old Golds somehow-and starts putting down a cop
    con that was really bottled in bond. Not a bad guy, and I didn't
    want to do it. But it was my only chance.
    I was just tying up for my morning shot when they walked in
    with a passkey. It was a special kind you can use even when the
    door is locked from the inside with a key in the lock. On the table
    in front of me was a packet of junk, spike, syringe-I got the habit
    of using a regular syringe in Mexico and never went back to using
    a dropper-alcohol, cotton and a glass of water.
    "Well well," says O'Brien ... "Long time no see eh?"
    "Put on your coat, Lee," says Hauser. He had his gun out. He
    always has it out when he makes a pinch for the psychological
    effect and to forestall a rush for toilet, sink or window.
    "Can I take a bang first, boys?" I asked ... "There's plenty here
    for evidence ..."
    I was wondering how I could get to my suitcase if they said no.
    The case wasn't locked, but Hauser had the gun in his hand.
    "He wants a shot," said Hauser.
    "Now you know we can't do that, Bill," said O'Brien in his sweet
    con voice, dragging out the name with an oily, insinuating familiarity,
    brutal and obscene.
    He meant, of course, "What can you do for us, Bill?" He looked
    at me and smiled. The smile stayed there too long, hideous and
    naked, the smile of an old painted pervert, gathering all the negative
    evil of O'Brien's ambiguous function.
    "I might could set up Marty Steel for you," I said.
    I knew they wanted Marty bad. He'd been pushing for five
    years, and they couldn't hang one on him. Marty was an old-timer,
    and very careful about who he served. He had to know a man
    and know him well before he would pick up his money. No one
    can say they ever did time because of me. My rep is perfect, but
    still Marty wouldn't serve me because he didn't know me long
    enough. That's how skeptical Marty was.
    "Marty?" said O'Brien. "Can you score from him?"
    "Sure I can."
    They were suspicious. A man can't be a cop all his life without
    developing a special set of intuitions.
    "O.K.," said Hauser finally. "But you'd better deliver, Lee."
    "I'll deliver all right. Believe me I appreciate this."
    I tied up for a shot, my hands trembling with eagerness, an
    archetype dope fiend.
    "Just an old junky, boys, a harmless old shaking_ wreck of a
    junky." That's the way I put it down. As I had hoped, Hauser
    looked away when I started probing for a vein. It's a wildly unpretty
    spectacle.
    O'Brien was sitting on the arm of a chair smoking an Old Gold,
    looking out the window with that dreamy what I'll do when I get
    my pension look.
    I hit a vein right away. A column of blood shot up into the
    syringe for an instant sharp and solid as a red cord. I pressed the
    plunger down with my thumb, feeling the junk pound through
    my veins to feed a million junk-hungry cells, to bring strength
    and alertness to every nerve and muscle. They were not watching
    me. I filled the syringe with alcohol.
    Hauser was juggling his snub-nosed detective special, a Colt,
    and looking around the room. He could smell danger like an
    animal. With his left hand he pushed the closet door open and
    glanced inside. My stomach contracted. I thought, "If he looks
    in the suitcase now I'm done."
    Hauser turned to me abruptly. "You through yet?" he snarled.
    "You'd better not try to shit us on Marty." The words came out
    so ugly he surprised and shocked himself.
    I picked up the syringe full of alcohol, twisting the needle to
    make sure it was tight.
    "Just two seconds," I said.
    I squirted a thin jet of alcohol, whipping it across his eyes with
    a sideways shake of the syringe. He let out a bellow of pain. I could
    see him pawing at his eyes with the left hand like he was tearing
    off an invisible bandage as I dropped to the floor on one knee,
    reaching for my suitcase. I pushed the suitcase open, and my left
    hand closed over the gun butt-I am right-handed but I shoot with
    my left hand. I felt the concussion of Hauser's shot before I heard
    it. His slug slammed into the wall behind me. Shooting from the
    floor, I snapped two quick shots into Hauser's belly where his vest
    had pulled up showing an inch of white shirt. He grunted in a way
    I could feel and doubled forward. Stiff with panic, O'Brien's hand
    was tearing at the gun in his shoulder holster. I clamped my other
    hand around my gun wrist to steady it for the long pull-this gun
    has the hammer filed off round so you can only use it double action-
    and shot him in the middle of his red forehead about two
    inches below the silver hairline. His hair had been grey the last
    time I saw him. That was about 15 years ago. My first arrest. His
    eyes went out. He fell off the chair onto his face. My hands were
    already reaching for what I needed, sweeping my notebooks into a
    briefcase with my works, junk, and a box of shells. I stuck the gun
    into my belt, and stepped out into the corridor putting on my coat.
    I could hear the desk clerk and the bell boy pounding up the
    stairs. I took the self-service elevator down, walked through the
    empty lobby into the street.
    It was a beautiful Indian summer day. I lmew I didn't have much
    chance, but any chance is better than none, better than being a
    subject for experiments with ST (6) or whatever the initials are.
    I had to stock up on junk fast. Along with airports, R.R. stations
    and bus terminals, they would cover all junk areas and connections.
    ...
    "What!!!? Already?"
    "Huh? ... But this I'm taking you to now is 0.1(. In fact it's
    about the best deal around that I know of ... Stop here."
    "Please make it fast," I said.
    "It should be a matter of ten minutes unless he's out of stuff
    and has to make a run ... Better sit down over there and have a
    cup of coffee ... This is a hot neighborhood."
    I sat down at a counter and ordered coffee, and pointed to a
    piece of Danish pastry under a plastic cover. I washed down the
    stale rubbery cake with coffee, praying that just this once, please
    God, let him make it now, and not come back to say the man is
    all out and has to make a run to East Orange or Greenpoint.
    Well here he was back, standing behind me. I looked at him,
    afraid to ask. Funny, I thought, here I sit with perhaps one chance
    in a hundred to live out the next 24 hours-I had made up my
    mind not to surrender and spend the next three or four months
    in death's waiting room. And here I was worrying about a junk
    score. But I only had about five shots left, and without junk I
    would be immobilized ...
    Nick nodded his head.
    "Don't give it to me here," I said. "Let's take a cab."
    We took a cab and started downtown. I held out my hand and
    copped the package, then I slipped a fifty-dollar bill into Nick's
    palm. He glanced at it and showed his gums in a toothless smile:
    "Thanks a lot ... This will put me in the clear ..."
    I sat back letting my mind work without pushing it. Push your
    mind too hard and it will fuck up like an overloaded switchboard,
    or turn on you with sabotage ... And I had no margin for error.
    Americans have a special horror of giving up control, of letting things
    happen in their own way without interference. They would like to
    jump down into their stomachs and digest the food and shovel the
    shit out.
    Your mind will answer most questions if you learn to relax and
    wait for the answer. Like one of those thinking machines, you
    feed in your question, sit back, and wait ...
    I was looking for a name. My mind was sorting through names,
    discarding at once: F.L.-Fuzz Lover; B.W.-Born Wrong; N.C.B.C.Nice
    Cat But Chicken ... putting aside to reconsider, narrowing,
    sifting, feeling for the name, the answer.
    "Sometimes, you know, he'll keep me waiting three hours.
    Sometimes I make it right away like this."
    Nick had a deprecating little laugh that he used for punctuation.
    Sort of an apology for talking at all in the telepathizing world
    of the addict where only the quantity factor-How much $? How
    much junk?-requires verbal expression. He knew and I knew all
    about waiting. At all levels the drug trade operates without schedule.
    Nobody delivers on time except by accident. The addict runs
    on junk time. His body is his clock, and junk runs through it like
    an hourglass. Time has meaning for him only with reference to
    his need.65 Then he makes his abrupt intrusion into the time of
    others, and, like all Outsiders, all Petitioners, he must wait, unless
    he happens to mesh with non-junk time.
    "What can I say to him? He knows I'll wait," Nick laughed.
    I spent the night in the Ever Hard Baths-(homosexuality is the
    best all-around cover story an agent can use}-where a snarling
    Italian attendant creates such an unnerving atmosphere sweeping
    the dormitory with infrared see-in-the-dark field glasses.
    ("All right in the North East corner! I see you!"-switching on
    floodlights, sticking his head through trap doors in the floor and
    wall of the private rooms, that many a queen has been carried
    out in a straitjacket ...)
    I lay there in my open-top cubicle room looking at the ceiling
    ... listened to the grunts and squeals and snarls in the nightmare
    half-light of random, broken lust ...
    "Fuck off you!"
    "Put on two pairs of glasses and maybe you can see something!"
    Walked out i n the precise morning and bought a paper ...
    Nothing ...
    ...
    I hung up and took a taxi out of the area ... In the cab I realized
    what had happened ... I had been occluded from space-time
    ...
    "Feel like a shot of heroin, Bill?"
    ...
    "Oh be careful! There they go again!" said the old queen as his string broke spilling his balls over the floor ...
    
    "Stop them will you, James, you worthless old shit! Don't just stand there and let the Master's balls roll into the coal-bin!"
    ...
    The Boy Burglar, fucked in the long jail term, ousted from the cemetery for the nonpayment, comes gibbering into the queer bar with a moldy pawn ticket to pick up the back balls of Tent City where castrate salesmen sing the IBM song.
    ...
    I mean not a young chick but built ...
    
    "How about a fix first?"
    ...
    The other day I am returning from the long lunch thread from mouth to ass all the days of our years, when I see an Arab boy have this little black and white dog know how to walk on his hind legs ... And a big yaller dog come on the boy for affection and the boy shove it away, and the yaller dog growl and snap at the little toddler, snarling if he had hut human gift of tongues: "A crime against nature right there."
    ...
    The Texas sheriff has killed his complicit Vet, Brubeck The Unsteady, involved in horse heroin racket.
